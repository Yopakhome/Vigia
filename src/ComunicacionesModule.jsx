...
import { Upload, FileText, AlertTriangle, CheckCircle, Clock, ChevronRight, Zap, MessageSquare, ArrowDown, ArrowUp, HelpCircle, Link, Eye, RefreshCw, X, Check, Mail, File, Archive, Image } from "lucide-react";
...
function FileTypeIcon({type}) {
  const icons = { pdf:<FileText size={16}/>, zip:<Archive size={16}/>, jpg:<Image size={16}/>, png:<Image size={16}/>, msg:<Mail size={16}/>, eml:<Mail size={16}/>};
        ...
        <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:24,marginBottom:20,animation:"fadeIn 0.3s ease"}}>
          ...
          <div style={{display:"flex",gap:10}}>
            <button onClick={confirmAndLink} style={{flex:1,background:C.primary,border:"none",borderRadius:8,padding:"10px",color:C.bg,fontSize:13,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:7}}>
              <Link size={13}/> Vincular al EDI y aplicar cambios
            </button>
