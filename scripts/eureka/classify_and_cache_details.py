#!/usr/bin/env python3
"""Recorre los 270 detalles de Normativa EUREKA una sola vez.

Por cada detalle:
  1. Guarda el HTML completo en scripts/eureka/html_cache/<subcat>__<slug>.html
  2. Clasifica el tipo de fuente primaria (inline_pdf / external_official /
     external_other / none)
  3. Extrae título limpio y URL del PDF inline si aplica
  4. Append a source_classification.json con progreso incremental

Resiliente: si se interrumpe, relanzar salta los docs ya cacheados.
Delay 3s entre requests, respeta errores 429/503 con abort.
"""
...
RECON = HERE / "recon_normativa.json"
CACHE_DIR = HERE / "html_cache"
OUT = HERE / "source_classification.json"
