#!/usr/bin/env python3
"""Descarga los PDFs inline identificados en source_classification.json.

Solo toca docs con primary_source.kind == "inline_pdf". Guarda en
scripts/eureka/samples/normativa/<subcat>__<slug>.pdf con metadata al lado.
"""
...
OUT_DIR = HERE / "samples" / "normativa"
REPORT = HERE / "download_report.json"
