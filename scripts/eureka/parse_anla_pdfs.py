#!/usr/bin/env python3
"""Parsea los PDFs descargados: detecta text-layer, extrae artículos,
identifica tipo/número/año de norma. Similar al pipeline de Sprint A.

Salida: parse_report.json con estadísticas + parsed_data.json con el
contenido estructurado por doc (listo para ingesta futura en Fase 2).
"""
...
DL_REPORT = HERE / "download_report.json"
PDFS_DIR = HERE / "samples" / "normativa"
OUT_REPORT = HERE / "parse_report.json"
OUT_DATA = HERE / "parsed_data.json"
